...
func Build(slave entrypoint.Slaver) (*Http, func(), error) {
	...
	config2, cleanup13, err := graphql.Cfg(configurator)
	if err != nil {
		cleanup12()
		cleanup11()
		cleanup10()
	...
	graphQL, cleanup14, err := graphql.Provider(context, graphqlConfig, awareSet, config2)
	if err != nil {
		cleanup13()
		cleanup12()
		cleanup11()
	...
	httpConfig, cleanup15, err := Cfg(configurator)
	if err != nil {
		cleanup14()
		cleanup13()
		cleanup12()
	...
	chiMux, cleanup16, err := Mux(routers, httpConfig)
	if err != nil {
		cleanup15()
		cleanup14()
		cleanup13()
	...
	http, cleanup17, err := Provider(context, chiMux, awareSet, httpConfig)
	if err != nil {
		cleanup16()
		cleanup15()
		cleanup14()
...
func BuildTest(slave entrypoint.Slaver) (*Http, func(), error) {
	...
	config2, cleanup12, err := graphql.CfgTest()
	if err != nil {
		cleanup11()
		cleanup10()
		cleanup9()
	...
	graphQL, cleanup13, err := graphql.Provider(context, graphqlConfig, awareSet, config2)
	if err != nil {
		cleanup12()
		cleanup11()
		cleanup10()
	...
	httpConfig, cleanup14, err := CfgTest()
	if err != nil {
		cleanup13()
		cleanup12()
		cleanup11()
	...
	http, cleanup16, err := Provider(context, chiMux, awareSet, httpConfig)
	if err != nil {
		cleanup15()
		cleanup14()
		cleanup13()
